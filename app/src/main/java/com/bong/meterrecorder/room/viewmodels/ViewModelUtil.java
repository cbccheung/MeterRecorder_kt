...
// Ref: https://proandroiddev.com/reducing-viewmodel-provision-boilerplate-in-googles-githubbrowsersample-549818ee72f0
    ...
    public static <T extends ViewModel> ViewModelProvider.Factory createFor(T model){
        return new ViewModelProvider.Factory() {
            ...
            public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
                ...
                throw new IllegalArgumentException("unexpected model class "+modelClass.getName());
            }
        };
    }
